...
public class FormatUtilsTest {
    ...
    /** 
     * Tests that distanceToStringWithoutUnitName works as expected
     * (most cases are allready tested in testDistanceToString()).
     */
    @Test
    ...
    /** 
     * Tests that speedToStringWithoutUnitName works as expected
     * (most cases are allready tested in testSpeedToString()).
     */
    @Test
    ...
    /** 
     * Tests that heightToStringWithoutUnitName works as expected
     * (most cases are allready tested in testHeightToString()).
     */
    @Test
    ...
    /**
     * Tests that weightToStringWithoutUnitName works as expected
     * (most cases are allready tested in testweightToString()).
     */
    @Test
