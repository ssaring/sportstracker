...
public class FormatUtilsTest {
    ...
    public void testCadenceToString() {
        assertEquals("0 r|spm", new FormatUtils(FormatUtils.UnitSystem.Metric, FormatUtils.SpeedView.DistancePerHour).cadenceToString(0));
        assertEquals("90 r|spm", new FormatUtils(FormatUtils.UnitSystem.Metric, FormatUtils.SpeedView.DistancePerHour).cadenceToString(90));
        assertEquals("1,234 r|spm", new FormatUtils(FormatUtils.UnitSystem.Metric, FormatUtils.SpeedView.DistancePerHour).cadenceToString(1234));
    }
