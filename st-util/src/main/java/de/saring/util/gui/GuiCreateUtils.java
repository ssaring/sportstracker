...
public class GuiCreateUtils {
    ...
    /**
     * Creates a JXDatePicker component, the displayed date uses the 
     ...
     * selects the complete textfield content when it gets the focus. The spinner
     * also has mouse wheel support (works for all model types).
     * 
    ...
    /**
     * Adds mouse wheel support to the specified JSpinner widget. It's generic and works
     * for all SpinnerModels.
     *
     ...
     * placed on the right side. Each button will have the same width. 
     * A horizontal JSeparator is located at the top of the panel.<br/>
     * 
