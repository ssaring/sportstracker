...
public class ChartUtils {
    ...
    /**
     * Customizes the chart for SportsTracker requirements. The chart background will be the same
     * as the parent component background. The plot background is white and the gridlines are grey.
     * The diagram will use the same font as the parent component (otherwise it has BIG fonts on
     * Win32 systems).
