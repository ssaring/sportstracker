...
public class STViewImpl extends FrameView implements STView {
    ...
    public void switchToView (EntryView.ViewType viewType) {
        ...
        switch (viewType) {
            case CALENDAR: currentView = calendarView; break;
            case EXERCISE_LIST: currentView = exerciseListView; break;
            case NOTE_LIST: currentView = noteListView; break;
            case WEIGHT_LIST: currentView = weightListView; break;
        }
