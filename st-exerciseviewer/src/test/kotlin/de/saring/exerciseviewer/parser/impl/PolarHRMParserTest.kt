...
class PolarHRMParserTest {
    ...
    fun testParseExerciseWithMetricUnits() {
        ...
        assertEquals(0.toShort(), exercise.lapList[2].speed.cadence)
        ...
        assertEquals(0.toShort(), exercise.lapList[4].speed.cadence)
        ...
        assertEquals(0.toShort(), exercise.sampleList[100].cadence)
        ...
        assertEquals(0.toShort(), exercise.sampleList[200].cadence)
        ...
        assertEquals(0.toShort(), exercise.sampleList[293].cadence)
    ...
    fun testParseCyclingExerciseWithEnglishUnits() {
        ...
        assertEquals(0.toShort(), exercise.lapList[3].speed.cadence)
        ...
        assertEquals(0.toShort(), exercise.sampleList[204].cadence)
    ...
    fun testParseRunningExerciseWithMetricUnits() {
        ...
        assertEquals(0f, exercise.sampleList[0].speed, 0f)
        assertEquals(0.toShort(), exercise.sampleList[0].cadence)
        assertEquals(0, exercise.sampleList[0].distance)
        ...
        assertEquals(0f, exercise.sampleList[100].speed, 0.0001f)
        assertEquals(0.toShort(), exercise.sampleList[100].cadence)
        assertEquals(0, exercise.sampleList[100].distance)
        ...
        assertEquals(0f, exercise.sampleList[150].speed, 0.0001f)
        assertEquals(0.toShort(), exercise.sampleList[150].cadence)
        assertEquals(0, exercise.sampleList[150].distance)
        ...
        assertEquals(0f, exercise.sampleList[169].speed, 0.0001f)
        assertEquals(0.toShort(), exercise.sampleList[169].cadence)
        assertEquals(0, exercise.sampleList[169].distance)
    }
}
