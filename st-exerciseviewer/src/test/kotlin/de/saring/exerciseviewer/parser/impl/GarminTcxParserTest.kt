...
class GarminTcxParserTest {
    ...
    fun testForerunner305_Running_NoHeartrate_1Lap() {
        ...
        assertNull(exercise.lapList[0].heartRateSplit)
        assertNull(exercise.lapList[0].heartRateAVG)
        assertNull(exercise.lapList[0].heartRateMax)
        ...
        assertNull(exercise.sampleList[378].heartRate)
        ...
        assertNull(exercise.sampleList[378].cadence)
    ...
    fun testEdge705_Running_Heartrate_2Laps() {
        ...
        assertNull(exercise.sampleList[1253].cadence)
    ...
    fun testForerunner405_Running_Heartrate_RunCadence() {
        ...
        assertNull(exercise.sampleList[20].altitude)
